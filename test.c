// Outputs a WASM file with two entries/example for each section (where allowed).
// Compile with: gcc wasm_both_examples_single_module.c -o makewasm
...
unsigned char wasm_both_examples[] = {
    ...
    0x06, 0x10,
      ...
      0x7D,0x01,0x43,0x00,0x00,0x60,0x40,0x0B, // f32, mutable, f32.const 3.5, end
    ...
    0x09, 0x11,
      ...
      0x00,0x41,0x01,0x0B,0x02,0x01,0x02, // table 0, offset 1, 2 funcs (1,2)

    // Code Section (2 functions)
    0x0A, 0x14,
      0x02, // count: 2
      0x04,0x00,0x41,0x2A,0x0B,             // body: i32.const 42, end
      0x07,0x00,0x20,0x00,0x20,0x01,0x6A,0x0B, // body: get_local 0, get_local 1, i32.add, end
